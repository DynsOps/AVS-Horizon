...
export const ContractedAnalysisReport: React.FC = () => {
  ...
  useEffect(() => {
    api.customer.getContractedAnalysisReport(user?.companyId).then(setData);
  }, [user?.companyId]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Category distribution for contracted usage.</p>
      </div>
